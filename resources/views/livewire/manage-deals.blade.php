<div>
    <div>
        <div class="flex justify-between mx-7">
            ...
            <x-button wire:click="confirmDealAdd"  class="px-5 py-2 text-white bg-gray-500 rounded-md hover:bg--600">
                Create
            </x-button>
        </div>
        <div class="mt-4">
        ...
        <div class="overflow-auto rounded-lg border border-gray-200 shadow-md m-5">
            ...
            <div class="w-1/3 float-right m-4">
                ...
                <div class="relative">
                    ...
                    <button type="submit" class="text-white absolute right-2.5 bottom-2.5 bg-gray-600 hover:bg-gray-700 focus:ring-4 focus:outline-none focus:ring-gray-300 font-medium rounded-lg text-sm px-4 py-2">Search</button>
                </div>
            </div>
            ...
            <x-dialog-modal wire:model="confirmingDealAdd">
                ...
                <x-slot name="content">
                            ...
                            <div>
                                ...
                                <input type="text" wire:model="newDeal.name" id="name" class="block w-full mt-1 border-gray-300 rounded-md shadow-sm focus:ring-gray-500 focus:border-gray-500 sm:text-sm">
                                @error('newDeal.name') <span class="text-red-500">{{ $message }}</span>@enderror
                            </div>
                            <div>
                                <label for="description" class="block text-sm font-medium text-gray-700">Description</label>
                                <input type="text" wire:model="newDeal.description" id="description" class="block w-full mt-1 border-gray-300 rounded-md shadow-sm focus:ring-gray-500 focus:border-gray-500 sm:text-sm">
                        ...
                        <div class="grid grid-cols-1 gap-6 mt-4 sm:grid-cols-2">
                            ...
                            <div>
                                ...
                                <input type="date" wire:model="newDeal.start_date" id="start_date" class="block w-full mt-1 border-gray-300 rounded-md shadow-sm focus:ring-gray-500 focus:border-gray-500 sm:text-sm">
                            ...
                            <div>
                                ...
                                <input type="date" wire:model="newDeal.end_date" id="end_date" class="block w-full mt-1 border-gray-300 rounded-md shadow-sm focus:ring-gray-500 focus:border-gray-500 sm:text-sm">
                        ...
                        <div>
                            ...
                            <input type="number" wire:model="newDeal.discount" id="discount" class="block w-full mt-1 border-gray-300 rounded-md shadow-sm focus:ring-gray-500 focus:border-gray-500 sm:text-sm">
                        ...
                        <div class="grid grid-cols-1 gap-6 mt-4 sm:grid-cols-2">
                            <div>
                                ...
                                <input type="checkbox" wire:model="newDeal.is_hidden" id="is_hidden" class="block w-5 h-5 mt-1 border-gray-300 rounded-md shadow-sm focus:ring-gray-500 focus:border-gray-500 sm:text-sm">
