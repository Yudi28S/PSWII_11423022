            ...
            <div class="flex flex-col md:flex-row gap-4">
                ...
                <div class="md:w-1/4">
                    <div class="bg-white rounded-lg shadow-md p-6">
                        ...
                        <button @click="showCheckoutConfirmation = true" class="bg-gray-500 text-white py-2 px-4 rounded-lg mt-4 w-full">Checkout</button>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="bg-white rounded-lg p-4 max-w-md mx-auto"  @click.outside="showCheckoutConfirmation = false" >
                ...
                <div class="mt-4 flex justify-end space-x-4">
                    ...
                    <form action="{{route('cart.checkout')}}" method="post">
                        @csrf
                        <button class="px-4 py-2 text-sm font-medium text-white bg-gray-600 border border-transparent rounded-md hover:bg-gray-700 focus:outline-none">
                            Confirm
                        </button>
                    </form>
