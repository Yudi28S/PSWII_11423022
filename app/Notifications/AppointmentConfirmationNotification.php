...
class AppointmentConfirmationNotification extends Notification implements ShouldQueue
{
    ...
    public function toMail($notifiable): MailMessage
    {
        return (new MailMessage)
            ->subject( 'Appointment Confirmation - badminton Bliss 🎉' . $this->appointment->service->name)
            ->from('noreply@badmintonbliss.com')
            ...
            ->line('Thank you for using badminton Bliss! We hope to see you again soon.');
